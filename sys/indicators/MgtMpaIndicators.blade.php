            ...
            <div class="table-responsive">
                <table class="table table-vcenter card-table tableme">
                    ...
                    <tbody>
                                        ...
                                        <div class="modal-body">
                                            <form action="{{ route('mpaIndicators.UpdateIndicator') }}" method="POST"
                                                ...
                                                <div class="col-md-6">
                                                    ...
                                                    <select class="form-select" name="IndicatorPrimaryCategory"
                                                        required>
                                                        <option value="RRF"
                                                            @if ($indicator->IndicatorPrimaryCategory === 'RRF') selected @endif>
                                                            RRF
                                                        </option>
                                                        <option value="CRF"
                                                            @if ($indicator->IndicatorPrimaryCategory === 'CRF') selected @endif>
                                                            CRF
                                                        </option>
                                                    </select>
                                                </div>
                                                ...
                                                <div class="col-md-6">
                                                    ...
                                                    <input type="text" class="form-control"
                                                        ...
                                                        value="{{ $indicator->IndicatorSecondaryCategory }}" required>
                                                </div>

                                                <!-- IID (Unique) -->
                                                <div class="col-md-6">
                                                    <label class="form-label">IID</label>
                                                    <input type="text" class="form-control" name="IID"
                                                        value="{{ $indicator->IID }}" required>
                                                </div>
                                                ...
                                                <div class="col-md-6">
                                                    ...
                                                    <select class="form-select" name="ResponseType" required>
                                                        <option value="Text"
                                                            @if ($indicator->ResponseType === 'Text') selected @endif>
                                                            Text
                                                        </option>
                                                        <option value="Number"
                                                            @if ($indicator->ResponseType === 'Number') selected @endif>
                                                            Number
                                                        </option>
                                                        <option value="Boolean"
                                                            @if ($indicator->ResponseType === 'Boolean') selected @endif>
                                                            Boolean
                                                        </option>
                                                        <option value="Yes/No"
                                                            @if ($indicator->ResponseType === 'Yes/No') selected @endif>
                                                            Yes/No
                                                        </option>
                                                    </select>
                                                </div>
                                                ...
                                                <div class="col-md-6">
                                                    ...
                                                    <select class="form-select" name="ReportingPeriod" required>
                                                        <option value="Quarterly"
                                                            @if ($indicator->ReportingPeriod === 'Quarterly') selected @endif>
                                                            Quarterly
                                                        </option>
                                                        <option value="Bi-Annual"
                                                            @if ($indicator->ReportingPeriod === 'Bi-Annual') selected @endif>
                                                            Bi-Annual
                                                        </option>
                                                        <option value="Annual"
                                                            @if ($indicator->ReportingPeriod === 'Annual') selected @endif>
                                                            Annual
                                                        </option>
                                                    </select>
                                                </div>
                        ...
                        @empty
                            <tr>
                                <td colspan="7" class="text-center">No indicators found for this entity.</td>
                            </tr>
                        @endforelse
                    </tbody>
                </table>
        ...
        <div class="modal-content border-0 shadow-lg">
            ...
            <div class="modal-body">
                <form action="{{ route('mpaIndicators.StoreIndicator') }}" method="POST" id="addIndicatorForm"
                    ...
                    <div class="col-md-6">
                        <label class="form-label">Secondary Category</label>
                        <input type="text" class="form-control" name="IndicatorSecondaryCategory" required>
                    </div>

                    <!-- IID (Unique) -->
                    <div class="col-md-6">
                        <label class="form-label">IID</label>
                        <input type="text" class="form-control" name="IID" required>
                    </div>
