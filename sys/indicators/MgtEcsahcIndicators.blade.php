    ...
    <div class="modal-dialog modal-full-width modal-dialog-centered" role="document">
        <div class="modal-content border-0 shadow-lg">
            ...
            <div class="modal-body">
                <form action="{{ route('AddEcsahcIndicators') }}" method="POST" id="addIndicatorForm" class="row">
                    @csrf
                    ...
                    <div class="col-4 mb-3">
                        ...
                        <input type="number" class="form-control" id="Baseline_2023_2024" name="Baseline_2023_2024">
                    </div>
