                ...
                <div class="row flex-fill align-items-center">
                    <div class="col">
                        <ul class="navbar-nav">
                            ...
                            {{-- Only Admins see the following sections, now with a type check --}}
                            @if ($isAdmin)
                                            ...
                                            <div class="dropdown-menu-column">
                                                @if ($userType === 'MPA')
                                                    ...
                                                    <a class="dropdown-item"
                                                        href="{{ route('MgtMpaTimelinesStatus') }}">MPA Timelines
                                                        Status</a>
                                                @elseif ($userType === 'ECSA-HC')
                                                    <a class="dropdown-item"
                                                        href="{{ route('MgtEcsaTimelines') }}">ECSA-HC Timelines</a>
                                                    <a class="dropdown-item"
                                ...
                                <li class="nav-item dropdown">
                                    ...
                                    <div class="dropdown-menu">
                                        <div class="dropdown-menu-columns">
                                            <div class="dropdown-menu-column">
                                                @if ($userType === 'MPA')
                                                    <a class="dropdown-item" href="{{ route('MgtMpaUsers') }}">MPA
                                                        Users</a>
                                                @elseif ($userType === 'ECSA-HC')
                                            ...
                                            <div class="dropdown-menu-column">
                                                @if ($userType === 'MPA')
                                                    ...
                                                    <a class="dropdown-item"
                                                        ...
                                                        Indicators</a>
                                                @elseif ($userType === 'ECSA-HC')
                                                    <a class="dropdown-item" href="{{ route('MgtSO') }}">ECSA-HC
